...
const ClientSupport = ({navigation}) => {
    ...
    <SafeAreaView style={styles.root}>
      <ScrollView
        ...
        <View style={{width: '100%', marginTop: 26, alignItems: 'center'}}>
          <Text style={styles.loginLbl}>Contact Support</Text>
          <View style={{width: '80%'}}>
            <View style={Styles.mgTop16}>
              <View style={Styles.customInpContainer}>
                <Text style={Styles.customTxtInpTtl}>{'Name'}</Text>
                <TextInput
                  value={password}
            ...
            <View style={Styles.mgTop16}>
              <View style={Styles.customInpContainer}>
                <Text style={Styles.customTxtInpTtl}>{'Contact Email'}</Text>
                <TextInput
                  value={password}
                  style={Styles.customTextInput}
                  underlineColorAndroid="transparent"
            ...
            <View style={Styles.mgTop16}>
              <View style={Styles.customInpContainer}>
                <Text style={Styles.customTxtInpTtl}>{'Issue Subject'}</Text>
                <TextInput
                  value={password}
                  style={Styles.customTextInput}
                  underlineColorAndroid="transparent"
